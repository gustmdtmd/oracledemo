...
-- DISTINCT : 중복제거 후 출력해주는 명령어, 컬럼앞에 사용 
...
/*
-- SELECT 입력순서
SELECT colum name1, colum name2
FROM table_name
...
-- employees테이블에서 first_name컬럼 값이  'David'일때의
-- first_name, salary를 출력하라.
SELECT first_name, salary
FROM employees
WHERE first_name = 'David';

-- employees테이블에서 first_name컬럼 값이  'David' 아닐때의
-- first_name, salary를 출력하라.
SELECT first_name, salary
FROM employees
WHERE first_name != 'David';
...
--first_name, hrie_date, salary을 출력하라.
SELECT first_name, hire_date, salary
FROM employees
...
--employees테이블에서 salary이 3000, 9000, 17000아닐 때
--first_name, hire_date, salary을 출력하라.
SELECT first_name, hire_date, salary
FROM employees
...
--employees테이블에서 salary이 3000부터 5000까지 아닐 때의
--first_name, hrie_date, salary을 출력하라.
SELECT first_name, hire_date, salary
FROM employees
