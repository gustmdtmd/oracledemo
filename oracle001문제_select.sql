oracle문제1_select.sql
오늘
오후 3:41

윤민영님이 항목 1개를 업로드했습니다.
SQL
oracle문제1_select.sql
/////////////////////////////////////
////--문제--
...
SELECT *
FROM employees
WHERE hire_date >= '2005/01/01'; --2005-01-01 도 가능
...
--WHERE hire_date BETWEEN '2005/01/01' AND '2005/12/12';
...
17) 업무이 'ST' 시작하는 사원의 사원명(first_name), 급여(salary), 업무(job_id)을 출력하시오.
SELECT first_name, salary, job_id
FROM employees
